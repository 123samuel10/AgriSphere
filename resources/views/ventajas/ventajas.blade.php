...
<div class="container py-12">
    <h1 class="text-center mb-8 text-4xl font-semibold text-green-700">Ventajas de AGRISPHERE</h1>
    <p class="text-center text-lg mb-10 text-gray-600">Optimiza la productividad agrícola con nuestras soluciones tecnológicas avanzadas</p>

    <!-- Sección de Ventajas -->
    <div class="space-y-6">
        <div class="flex items-start">
            <div class="text-green-700 text-2xl mr-4">
