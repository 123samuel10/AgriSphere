...
<div class="container py-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 text-center hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-600">Buscar correlacionar entre datos de lluvia, radiación, temperatura y productividades obtenidas.</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 text-center hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-600">Buscar correlación entre niveles de rotación de cultivos y productividad por hectárea.</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 text-center hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-600">Soportar la producción de semilla para producciones propias y de terceros.</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 text-center hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-600">Garantizar calidades según condiciones del mercado.</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 text-center hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-600">Ser competitivos en costos de semilla, fertilizantes y otros insumos.</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 text-center hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-600">Estandarizar información que permita análisis de costos de producción comparativos.</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 text-center hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-600">Gestionar el riesgo del crecimiento del negocio.</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 text-center hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-600">Gestionar las consecuencias del cambio climático (lluvia excesiva o sequía excesiva), amenazas productivas, biológicas y físicas.</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 text-center hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-600">Desarrollar procesos productivos estandarizados. BPM.</p>
        </div>
    </div>
</div>
@endsection
